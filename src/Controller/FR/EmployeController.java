...
//    Util util = new Util();
    ...
    private void saveAction(ActionEvent e) {
        ...
        es.create(new Employe(nom.getText(), prenom.getText(), selectedSexe, telephone.getText(), dt, cin.getText(), ps.findById(selectedProfilId), username.getText(), password.getText()));
